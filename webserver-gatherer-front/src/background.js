...
// NOTE: Code specific to webserverGatherer (background.js is mostly generated code from electron boilerplate)
...
app.on("ready", async () => {
  if (isDevelopment && !process.env.IS_TEST) {
    ...
    // Call electron-updater to check for new application version and update it in background if needed (electron-builder integration)
    // NOTE: For auto-updating to work on macOS, your code needs to be signed
