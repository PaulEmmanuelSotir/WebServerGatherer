<template>
  <v-container id="privacyPolicy">
    <v-card>
      <v-card-title class="headline grey lighten-2"> Privacy Policy for WebServer Gatherer </v-card-title>

      <v-card-text>
        <p>
          At WebServer Gatherer, accessible from paulemmanuelsotir.com/web-server-gatherer, one of our main priorities is the privacy of our
          visitors. This Privacy Policy document contains types of information that is collected and recorded by WebServer Gatherer and how
          we use it.
        </p>
        ...
        <p>
          ...
          that they shared and/or collect in WebServer Gatherer. This policy is not applicable to any information collected offline or via
        ...
        <p>
          WebServer Gatherer follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
        ...
        <P>You may consult this list to find the Privacy Policy for each of the advertising partners of WebServer Gatherer.</P>
        ...
        <p>
          ...
          advertisements and links that appear on WebServer Gatherer, which are sent directly to users' browser. They automatically receive
        ...
        <p>Note that WebServer Gatherer has no access to or control over these cookies that are used by third-party advertisers.</p>

        <h2>Third Party Privacy Policies</h2>

        <p>
          WebServer Gatherer's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
        ...
        <p>
          WebServer Gatherer does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you
          think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we
